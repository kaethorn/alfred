...
public class ComicFixtures {
  ...
  public static final Comic COMIC_V1_1 = Comic.builder()
      .path("/a1.cbz").fileName("a1.cbz").title("Title A1").series("Series A")
  ...
  public static final Comic COMIC_V1_2 = Comic.builder()
      .path("/a2.cbz").fileName("a1.cbz").title("Title A2").series("Series A")
  ...
  public static final Comic COMIC_V1_3 = Comic.builder()
      .path("/a3.cbz").fileName("a1.cbz").title("Title A3").series("Series A")
  ...
  public static final Comic COMIC_V2_1 = Comic.builder()
      .path("/b1.cbz").fileName("a1.cbz").title("Title B1").series("Series A")
  ...
  public static final Comic COMIC_V2_2 = Comic.builder()
      .path("/b2.cbz").fileName("a1.cbz").title("Title B2").series("Series A")
  ...
  public static final Comic COMIC_V2_3 = Comic.builder()
      .path("/b3.cbz").fileName("a1.cbz").title("Title B3").series("Series A")
  ...
  public static final Comic COMIC_V3_1 = Comic.builder()
      .path("/c1.cbz").fileName("a1.cbz").title("Title C1").series("Series A")
  ...
  public static final Comic COMIC_V3_2 = Comic.builder()
      .path("/c2.cbz").fileName("a1.cbz").title("Title C2").series("Series A")
  ...
  public static final Comic COMIC_V3_3 = Comic.builder()
      .path("/c3.cbz").fileName("a1.cbz").title("Title C3").series("Series A")
