...
import de.wasenweg.komix.comics.Comic.ComicBuilder;

public class ComicFixtures {

    public static final ComicBuilder COMIC_V1_1 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V1_2 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V1_3 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V2_1 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V2_2 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V2_3 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V3_1 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V3_2 = Comic.builder()
    ...
    public static final ComicBuilder COMIC_V3_3 = Comic.builder()
